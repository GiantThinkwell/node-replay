...
var BINARY_TYPES, Catalog, File, Matcher, Path, assert, exists, existsSync, isBinary, jsStringEscape, match, mkdir, parseHeaders, writeHeaders,
  __slice = [].slice;
...
isBinary = function(headers) {
  return (headers['content-encoding'] && headers['content-encoding'].match(BINARY_TYPES)) || (headers['content-type'] && headers['content-type'].match(BINARY_TYPES));
};
